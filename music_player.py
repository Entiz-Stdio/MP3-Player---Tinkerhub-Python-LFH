...
class FrameApp(Frame):
    def __init__(self,master):
        ...
        self.b1 = Button(self, text="play", command=self.play_music, width=8)
        ...
        self.b3 = Button(self, text="play/pause", command=self.toggle, width=8)
        self.b3.grid(row=3, column=0)

        self.b4 = Button(self, text="next", command=self.next_song, width=8)
        ...
        self.output = Text(self, wrap=WORD, width=37)
